...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2020 at 12:38 PM
...
('admin', 'admin', '101', 'admin', 'admin@gmail.com');
...
('Ritwick', '123', 'Ritwick Saha', 'ritwicksaha@gmail.com', '789456', '78 AB Road'),
('tayeeba', '456', 'Tayeeba', 'tayeeba@yahoo.com', '456', 'Uttara');
...
('AA101', 'dhaka', 'london', '2020-12-04', '2020-12-04', '09:00:00', '09:17:00', 2, 2, 500, 750, '10003'),
('AA102', 'london', 'dhaka', '2020-12-01', '2020-12-01', '13:00:00', '14:00:00', 1, 2, 3000, 3750, '10004');
...
('493675235', '3370677', '2020-09-11', 3850, 'credit card');
...
('3370677', '2020-09-11', 'AA102', '2020-12-01', 'economy', 'CONFIRMED', 1, 'yes', 'yes', 'yes', '493675235', 'Ritwick');
...
ALTER TABLE `ticket_details`
  ...
  ADD CONSTRAINT `ticket_details_ibfk_4` FOREIGN KEY (`payment_id`) REFERENCES `payment_details` (`payment_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
